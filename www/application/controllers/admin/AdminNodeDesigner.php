...
class AdminNodeDesigner extends CNode {
 ...
 */
	 ...
	 */
	public function index($nidtype = 'designer', $nid = '') {
		...
		//传入菜单按钮active状态
		$this->cismarty->assign("active", array(__CLASS__, __FUNCTION__));
		$title = t("designer_list");
		$this->cismarty->assign("title", $title);

		$this->cismarty->display("nodedesigner/nodedesigner_index.html");
