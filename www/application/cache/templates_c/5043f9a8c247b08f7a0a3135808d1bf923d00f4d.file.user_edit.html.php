<?php /* Smarty version Smarty-3.1.16, created on 2015-08-08 04:41:39
         compiled from "/www/hlsc/www/application/themes/admin/default/user_edit.html" */ ?>
<?php /*%%SmartyHeaderCode:172280446655c4eb27c5d308-59197925%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5043f9a8c247b08f7a0a3135808d1bf923d00f4d' => 
    array (
      0 => '/www/hlsc/www/application/themes/admin/default/user_edit.html',
      1 => 1438980018,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '172280446655c4eb27c5d308-59197925',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_55c4eb27dcaac1_50698534',
  'variables' => 
  array (
    'title' => 0,
    'THEMEPATH' => 0,
...
<?php if ($_valid && !is_callable('content_55c4eb27dcaac1_50698534')) {function content_55c4eb27dcaac1_50698534($_smarty_tpl) {?><!doctype html>
<html class="no-js">
  <head>
    <meta charset="UTF-8">
              ...
              <div class="col-lg-12">
                <div class="box dark">
                  ...
                  <div id="add-form" class="body">
                    <form class="form-horizontal" id="user_edit_validate">
                      <div class="form-group">
                        <label for="openid" class="control-label col-lg-4"><?php echo t("openid");?>
</label>
                        <div class="col-lg-4">

                          <input type="text" id="openid" name="openid" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['openid'];?>
" readonly class=" form-control">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-4">
                          <input class="form-control" type="headimg" id="headimg" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['headimg'];?>
"  name="headimg"/>
                        </div>
                      </div><!-- /.form-group -->
                      <div class="form-group">
                        ...
                        <div class="col-lg-4" id="sex">
                            <div class="checkbox">
                                <label>
                                    <input class="uniform" type="radio" name="sex" value="1" <?php if ($_smarty_tpl->tpl_vars['user']->value['sex']==1) {?>checked<?php }?>><?php echo t("man");?>

                                </label>
                                <label>
                                    <input class="uniform" type="radio" name="sex" value="0" <?php if ($_smarty_tpl->tpl_vars['user']->value['sex']==0) {?>checked<?php }?>><?php echo t("famale");?>
...
" name="realname" id="realname" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
                      <div class="form-group">
                        <label class="control-label col-lg-4" for="mobile"><?php echo t("mobile");?>
                          ...
                          <div class="col-lg-4">
                          <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['mobile'];?>
" name="mobile" id="mobile" class="form-control">
                      ...
                      <div class="form-group">
                        <label for="text2" class="control-label col-lg-4" for="qq"><?php echo t("qq");?>
                          ...
                          <div class="col-lg-4">
                          <input type="text" id="qq" name="qq" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['qq'];?>
" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
                       ...
                       <div class="form-group" >
                        ...
                        <div class="col-lg-4">
                          <input type="text" id="birthday" name="birthday" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['birthday'];?>
"  data-date="<?php echo $_smarty_tpl->tpl_vars['user']->value['birthday'];?>
" realonly data-date-format="yyyymmdd" class="form-control input-group input-append date">
                        </div>
                      </div><!-- /.form-group -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-4">
                          <textarea id="remark" name="remark" class="form-control"><?php echo $_smarty_tpl->tpl_vars['user']->value['remark'];?>
</textarea>
                        </div>
                      </div><!-- /.form-group -->
                      <div class="form-group">
                          ...
                          <div class="form-actions col-lg-4">
                            <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['uid'];?>
" name="uid" id="uid" />
...
/assets/js/app.js"></script>
    ...
    $("document").ready(function()
      {
          $('#user_edit_validate').validationEngine(); 
           $("#birthday").datepicker(); 
          $("#submit").click(function()
              {
                  if($('#user_edit_validate').validationEngine("validate") === true)
                  {
                      var uid = $("#uid").val();
                      ...
                      $.ajax({
                          url:"/admin/AdminUser/ajax_user_edit",
                          type:"post",
                          data:"uid="+uid+"&headimg="+headimg+"&realname="+realname+"&sex="+sex+"&mobile="+mobile+"&qq="+qq+"&birthday="+birthday+"&remark="+remark,
                          dataType:"json",
